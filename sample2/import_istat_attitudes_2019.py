...
class Istat:
    ...
    def __init__(self) -> None:
        ...
        self.file_path = 'AVQ_Microdati_2019.txt'
    ...
    def run(self):
        ...
        columns = [
            'ETAMi', 'SESSO', 'CONDMi', 'POSIZMi', 'ISTRMi', 'REGMf', 'VISMED12', 'ANSANG12', 'ACCER12', 
            ...
            'DISP_TAB', 'DISPPDA', 'INCOMU5', 'INCOMU1b', 'INCOMU6', 'INCOMU7', 
            ...
            'CLOUDSAL', 'P2P_ACC', 'P2P_ACCALT', 
            'P2P_TRA', 'P2P_TRALT', 'P2P_FOOD',  
            'TEATRO', 'MUSEO', 'MUSIC', 'MONUM', 'LQUOT', 'RIVSET', 
            'PGRVO', 'FINAS', 'VOLON', 'ATGRA', 'VOLPA', 'VOLSI', 'PAESAGGIO', 'SPORCO', 'PARCH', 
            'COLMP', 'TRAF', 'INQAR', 'RUMORE', 'CRIM', 'ODSGR', 'ILLSTR', 'CONPAV', 
        ...
        self.fields = {
            ...
            'digital_activity_index': Fields(
                ...
                'INCOMU6', 'INCOMU7', 'INTATT20', 'INTATT21', 'INTATT26', 'INTATT5',
                ...
                'INTATT30B', 'INTATT28A', 'INTATT28B', 'CLOUDSAL',
                'P2P_ACC', 'P2P_ACCALT', 'P2P_TRA', 'P2P_TRALT', 'P2P_FOOD'],
